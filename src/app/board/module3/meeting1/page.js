...
import Meeting2Popup from "@/app/components/meeting2popup.js";
...
export default function Meeting() {
  ...
  const [showMeetingModal21, setShowMeetingModal21] = React.useState(false);
  const [showMeetingModal22, setShowMeetingModal22] = React.useState(false);
  const [showMeetingModal3, setShowMeetingModal3] = React.useState(false);
  const [showMeetingModal4, setShowMeetingModal4] = React.useState(false);
  ...
  return (
    <section className="mt-32 mb-16 xl:px-12 flex flex-col items-center">
      ...
      <div className="container flex flex-col md:grid grid-cols-3 gap-5 h-min">
        ...
        <div className="meeting-card flex flex-col py-8 px-8 bg-white">
          ...
          <Image
            ...
            width={350}
            height={250}
            onClick={() => setShowMeetingModal21(true)}
          />
          <Image
            className="mx-auto my-1 cursor-pointer"
            ...
            width={350}
            height={250}
            onClick={() => setShowMeetingModal22(true)}
          />
      ...
      <Modal
        showModal={showMeetingModal21}
        setShowModal={setShowMeetingModal21}
      ...
      >
        ...
        <div className="flex items-center justify-end p-6">
          <Button
            className={"w-full"}
            onClick={() => setShowMeetingModal21(false)}
          >
            Proceed
          </Button>
        </div>
      ...
      {/* Company Financial Data Modal */}
      <Modal
        showModal={showMeetingModal22}
        setShowModal={setShowMeetingModal22}
      ...
      >
        ...
        <div className="flex items-center justify-end p-6">
          <Button
            className={"w-full"}
            onClick={() => setShowMeetingModal22(false)}
          >
            Proceed
          </Button>
        </div>
      ...
      {/* WHSE Promotional Video */}
      <Modal
        showModal={showMeetingModal3}
        setShowModal={setShowMeetingModal3}
      ...
      <Modal
        showModal={showMeetingModal4}
        setShowModal={setShowMeetingModal4}
        // title={"WHSE Promotional Video"}
        hideClose={true}
      >
        <div className="meeting-card flex flex-col py-8 px-8 bg-white">
          ...
          <Button
            className={"w-full mt-auto"}
            onClick={() => setShowMeetingModal4(false)}
          >
            Review
          </Button>
        </div>
